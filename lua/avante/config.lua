...
---@field runner "docker"|"native"|string|fun(config: avante.Config.RagService) Runner used to launch the RAG service; native expects avante-rag-service in PATH.
...
M._defaults = {
  ...
  rag_service = { -- RAG service configuration
    ...
    runner = "docker", -- Launch with docker, native, or a function accepting the RAG config
